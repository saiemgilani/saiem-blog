...
const tempData = {
  ...
  avatar_url: "https://avatars.githubusercontent.com/u/25425933?v=4",
  gravatar_id: "",
  url: "https://api.github.com/users/saiemgilani",
  html_url: "https://github.com/saiemgilani",
...
export async function fetchGithub() {
  ...
  return fetch("https://api.github.com/users/saiemgilani").then((res) => res.json());
}
...
export async function getGithubStarsAndForks() {
  ...
  const res = await fetch(
    "https://api.github.com/users/saiemgilani/repos?per_page=100"
  );
